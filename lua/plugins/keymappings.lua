...
keymap("n", "[d", function() vim.diagnostic.jump({ count = -1 }) end, opts) -- Go to previous diagnostic
keymap("n", "]d", function() vim.diagnostic.jump({ count = 1 }) end, opts) -- Go to next diagnostic
